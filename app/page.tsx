...
const MAKE_YOUR_OWN_STEPS = [
  ...
  {
    num: '02',
    title: 'KathaKitaab builds it',
    desc: 'gpt-4o-mini writes scene-by-scene narration, hotspots, and a quiz. gpt-image-1 paints each scene. Sarvam Bulbul records the narration in a voice the AI picked to match the character. All in parallel.',
...
// Books currently shippable end-to-end. Ramayana is the curated, pre-
// baked manifest; Akbar+Birbal is a real KathaKitaab generation —
// 9 scenes, gpt-4o-mini narration, gpt-image-1 art, Sarvam audio,
// generated and stored on Supabase. Both play in the live reader and
// in the in-browser <Player> on their movie page.
const FEATURED_BOOKS = [
  {
    slug: 'ramayana',
    title: 'Ramayana',
    subtitle: 'Curated · pre-baked manifest',
    blurb: 'The hand-tuned reference book — 12 scenes, 6:46 cinematic cut, all assets archived. The benchmark every generated book is measured against.',
    badge: 'Curated',
  ...
  },
  {
    ...
    blurb: 'Typed "Akbar and Birbal" → 9 scenes of Mughal court wit, every image painted by gpt-image-1, every narration recorded by Sarvam Bulbul, voices picked by archetype. Live reader and movie both work.',
    ...
    <main className="lp">
      ...
      <section className="lp-worlds" id="featured-books" style={{ paddingBottom: 0 }}>
        ...
        <p className="lp-section-sub">
          Two books — one curated, one generated end-to-end by KathaKitaab from a typed title.
          Both read interactively. Both play as a cinematic cut in the browser.
        </p>
        <div style={{
          display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))',
          gap: 22, maxWidth: 980, margin: '32px auto 0',
        }}>
